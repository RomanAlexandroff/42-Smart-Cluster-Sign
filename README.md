...
2. **Pre-exam warning**: Early in the morning of an exam day, the device hides the pictograms and adds a small informational note informing about the upcoming exam later in the day. This way, students who want to settle into the room can plan their work ahead with the cluster availability limitations in mind.
